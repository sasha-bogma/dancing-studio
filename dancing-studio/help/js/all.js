...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","Ознакомление с программой \"Система управления центром обучения и досуга\"","Основные функции главной страницы","Страница \"Ученики\"","Страница \"Преподаватели\"","Страница \"Журнал\"","Страница \"Расписание\""],
    DREX_NODE_LINKS: ["index.htm","oznakomlenie_s_programmoj__sistema_upravleniya_tsentrom_obucheniya_i_dosuga_.htm","osnovnye_funktsii_glavnoj_stranitsy.htm","stranitsa__ucheniki_.htm","stranitsa__prepodavateli_.htm","stranitsa__zhurnal_.htm","stranitsa__raspisanie_.htm"],
    DREX_NODE_CHILD_START: [1,7,7,7,7,7,7],
    DREX_NODE_CHILD_END: [7,7,7,7,7,7,7],
    DREX_MENU_TYPE: 1,
